            ...
            <CardBody display={"flex"} gap={5}>
              <Box w={"50%"}>
                ...
                {pijetUrutLaki.map((data) => (
                  <CardKangPijit key={data.id} id={data.id} phone={data.phone} image={data.image} name={data.name} gender={data.gender} email={data.email} district={data.district} address={data.address} />
                ))}
              </Box>
              <Box w={"50%"} ps={6}>
                <Heading size="sm" pb={2}>
